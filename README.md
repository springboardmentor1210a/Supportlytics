...
<img width="1335" height="743" alt="Overview" src="https://github.com/user-attachments/assets/4b7450f7-1907-40a2-957b-2fd0bee12793" />


2. Tickets Analysis

Tickets by channel, status, queue, customer segment, issue type and priority, plus reopened and total-ticket KPIs.
<img width="1340" height="741" alt="Tickets Analysis" src="https://github.com/user-attachments/assets/81d48824-1e6b-4f15-83b7-442258de11ab" />
...
<img width="1342" height="752" alt="Cluster Intelligence" src="https://github.com/user-attachments/assets/c433f881-01f8-46f0-a5ef-97a3d6e90929" />


4. Geographical Insights

Regional ticket distribution, maps, regional CSAT and geographic issue distribution.
<img width="1341" height="748" alt="Geographical Insights" src="https://github.com/user-attachments/assets/33198ebb-fbb3-41f1-9a5b-163e6b8ececb" />
...
<img width="1332" height="741" alt="Performance Analysis" src="https://github.com/user-attachments/assets/b77cfaae-7eb9-4921-87dd-98d8a4a2689f" />


6. Executive Report

Management-level KPIs, regional performance, critical ticket overview, performance gaps, key insights and recommendations.
<img width="1328" height="744" alt="Executive Report" src="https://github.com/user-attachments/assets/a3a1d0cb-b9b0-4df3-82b8-57581143b572" />


💡 Key Insights

MEA has the highest ticket volume, indicating greater support demand in the region.
...
High and urgent tickets require closer monitoring because they represent critical support cases.

Cluster-level analysis reveals different issue concentrations, helping identify recurring support patterns.

5,045 tickets were reopened, highlighting an opportunity to improve first-time resolution.

Average CSAT is 2.24, indicating an opportunity to improve customer experience.
